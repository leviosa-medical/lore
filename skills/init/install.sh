...
echo ""
echo "IMPORTANT: Restart Claude Code now (/exit or Cmd+R) so the MCP server and agent rule are loaded."
echo "After restart: run /lore:bootstrap to seed from existing CLAUDE.md and docs"
